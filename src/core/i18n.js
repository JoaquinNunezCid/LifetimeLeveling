...
const STRINGS = {
  es: {
    ...
    "settings.passwordConfirm": "Repetir nueva contraseña",
    "settings.passwordHint": "Deja en blanco si no quieres cambiarla.",
    ...
    "training.removeConfirm": "Quitar este ejercicio?",
    "training.reorder": "Reordenar",
  ...
  en: {
    ...
    "training.removeConfirm": "Remove this exercise?",
